...
class NewNeedsScreen extends StatefulWidget {
  @override
  _NewNeedsScreenState createState() => _NewNeedsScreenState();
}

class _NewNeedsScreenState extends State<NewNeedsScreen> {
  String name;
  String data;
  String price;
            ...
            InkWell(
              onTap: () async {
                NeedsModelDb needsModelDb =
                    NeedsModelDb(name: name, data: dropdwnValue0, price: price,currency: dropdwnValue1);
                await context
                    .read<DataBaseProvider>()
                    .insertNewNeeds(needsModelDb);
                Navigator.pop(context);
              },
              child: Container(
                  alignment: Alignment.center,
